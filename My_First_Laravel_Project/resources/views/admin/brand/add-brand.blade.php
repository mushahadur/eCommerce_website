                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('createBrand')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">Brand Status</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4">Brand Image</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="submit" name="btn" class="btn btn-outline-success " value="Add New Brand" />
                                    </div>
                                </div>
                            </form>
                        </div>
