                ...
                <div class="card-body">
                    ...
                    <form action="{{route('updateSubCategory', ['id' => $subCategory->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$subCategory->name}}" id="horizontal-firstname-input" name="name"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input3" class="col-sm-3 col-form-label">Description</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="horizontal-password-input3" name="description">{{$subCategory->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <img class="py-4" src="{{asset($subCategory->image)}}" alt="" height="170" width="180"/>
                            </div>
                        </div>
