            ...
            <div class="row s_product_inner justify-content-between">
                <div class="col-lg-7 col-xl-7">
                    <div class="product_slider_img">
                        <div id="vertical">
                            <div data-thumb="{{asset('/')}}assets/img/product/single-product/product_1.png">
                                <img src="{{asset('/')}}assets/img/product/single-product/product_1.png" />
                            </div>
                            <div data-thumb="{{asset('/')}}assets/img/product/single-product/product_1.png">
                                <img src="{{asset('/')}}assets/img/product/single-product/product_1.png" />
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="comment_list">
                                ...
                                <div class="review_item reply">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{asset('/')}}assets/img/product/single-product/review-2.png" alt="" />
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                            <h5>12th Feb, 2017 at 05:56 pm</h5>
                                ...
                                <div class="review_item">
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="{{asset('/')}}assets/img/product/single-product/review-3.png" alt="" />
                                        </div>
                                        <div class="media-body">
                                            <h4>Blake Ruiz</h4>
                                            <h5>12th Feb, 2017 at 05:56 pm</h5>
